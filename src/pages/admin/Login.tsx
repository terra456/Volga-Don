    ...
    <>
      <form onSubmit={handleSubmit} className={classes.auth__container}>
        <input
          ...
          onBlur={() => email.onBlur()}
        />
        {email.isDirty && email.isError && <div className={classes.auth__errorString}>{email.errorText}</div>}
        <input
          type="password"
          name="password"
          className={classes.auth__textBox}
        ...
        />
        {password.isDirty && password.isError && <div className={classes.auth__errorString}>{password.errorText}</div>}
        <button disabled={email.isError || password.isError || loading} className={classes.auth__btn} type="submit">
